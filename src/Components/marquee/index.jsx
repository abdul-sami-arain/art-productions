...
import video1 from "../../Assets/highlights/video1.mp4";
import video2 from "../../Assets/highlights/video2.mp4";
import video3 from "../../Assets/highlights/video3.mp4";
export default function Marquee1() {
    const navigate = useNavigate();
    return (
        <div className="main_marquee">
            <div className="marquee1">
                <MainHeading width={'95%'} gap={'10px'} flexDirection={'row'} margin={"0 0 20px 0"} content1={"Our "} content2={"Portfolio"} />
